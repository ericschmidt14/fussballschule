export default function Conditions() {
  return (
    <article className="muted small flex flex-col gap-2">
      <p>
        Veranstalter ist der 1. FC Nürnberg, FUSSBALL<b>SCHULE</b>, Verein für
        Leibesübungen e.V., Valznerweiherstraße 200, 90480 Nürnberg.
        Veranstaltungsort ist der Sportpark Valznerweiher (sofern nicht anders
      ...
      <p>
        <b>
          ...
          schriftlich (per Post oder Mail) an die FUSSBALL<b>SCHULE</b> des 1.
          FC Nürnberg bzw. den Teilnehmer gerichtet werden. Andernfalls
          verlängert sich die Laufzeit der Vereinbarung auf unbestimmte Zeit.
          Die Vertragsparteien können das verlängerte Vertragsverhältnis
      ...
      <p>
        ...
        der Trainingseinheiten im Rahmen der 1. FCN FUSSBALL<b>SCHULE</b> und
        des 1. FCN FUSSBALL<b>KINDERGARTEN</b> können zeitlich und räumlich
        unbegrenzt verwendet, d. h. hergestellt, verbreitet, vervielfältigt oder
